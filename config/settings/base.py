...
AUTHENTICATION_BACKENDS = [
    "voice_core.users.signin.cognito_and_model_backend.CognitoAndModelBackend",
]
...
CACHES = {
    ...
    "wazo_tokens": {
        ...
        "TIMEOUT": os.getenv("WAZO_TOKEN_EXPIRATION", 3600),  # 1 hour default
    },
}
...
# voicemail recording fetch timeout constants
VOICEMAIL_CONNECTION_TIMEOUT = os.getenv("VOICEMAIL_CONNECTION_TIMEOUT")
VOICEMAIL_READ_TIMEOUT = os.getenv("VOICEMAIL_READ_TIMEOUT")